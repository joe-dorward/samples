...
flowchart TD
  ...
  CATEGORISATION_NOTE("&ensp;Take a look at how MediaWiki&ensp;<br/>&ensp;categorisation works. It is<br/>&ensp;about structure and findability")
  ...
  MARKED_UP_CONTENT_NOTE["&ensp;Marked-up content 'should be', by definition,<br/>&ensp;structured in the sense of the Document<br/>&ensp;Object Model - in that it 'should be'<br/>&ensp;that it 'should be' a hierarchy of<br/>&ensp; elements"]

  %%HIGHLY_AVAILABLE_NOTE["&ensp;<b>Highly-available</b> implies that the content<br/>&ensp;<i>must be</i> online, that it's easy to access, and<br/>&ensp;that sought after content is easy to find"]
  HIGHLY_AVAILABLE_NOTE["&ensp;<b>Highly-available</b> implies that the<br/>&ensp;content<i>must be</i> online, that it's easy<br/>&ensp;to access, and that sought after<br/>&ensp;content is easy to find"]  
  HIGHLY_COLABORATIVE_NOTE["&ensp;<b>Highly-collaborative</b> implies an epectation<br/>&ensp;that some users of the content (not on the<br/>&ensp;initial content creation team) will make<br/>&ensp;changes without further permission"]
