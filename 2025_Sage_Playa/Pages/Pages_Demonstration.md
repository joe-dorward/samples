...
**Step 1** - I created these 'knowledge articles' about an abstract application named 'Pages': 
- [Page 1](page_1.md)
- [Page 2](page_2.md)
- [Page 3](page_3.md)

**Step 2** - I created an **Intent** with an agentic action that 'knows' about these 'knowledge articles'. 
